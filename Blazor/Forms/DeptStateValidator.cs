...
namespace Advanced.Blazor.Forms
{
    public class DeptStateValidator : OwningComponentBase<DataContext>
    {
        ...
        [CascadingParameter]
        public EditContext CurrentEditContext { get; set; }  //The EditForm component which is the Parent html element, provides this object
        ...
        {
            ValidationMessageStore store =  new ValidationMessageStore(CurrentEditContext); //Blazor automatically processes the messages in this store object
